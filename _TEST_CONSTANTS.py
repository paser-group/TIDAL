...
cross_port_yaml      = '/Users/arahman/PRIOR_NCSU/SECU_REPOS/ghub-ansi/laincloud@lain/playbooks/roles/config/defaults/main.yaml'
cross_no_inte_yaml1  = '/Users/arahman/PRIOR_NCSU/SECU_REPOS/ghub-ansi/openshift@openshift-ansible-contrib/reference-architecture/azure-ansible/3.5/ansibledeployocp/playbooks/roles/prepare/tasks/main.yaml'
cross_no_inte_yaml2  = '/Users/arahman/PRIOR_NCSU/SECU_REPOS/ghub-ansi/openshift@openshift-ansible-contrib/reference-architecture/azure-ansible/3.6/ansibledeployocp/playbooks/roles/prepare/tasks/main.yaml'
cross_no_inte_yaml3  = '/Users/arahman/PRIOR_NCSU/SECU_REPOS/ghub-ansi/redhat-performance@satellite-performance/playbooks/katello/roles/add_katello_repos/tasks/main.yaml'


KEY_MISSING_MESSAGE  = ': A KEY TO EXIST !!!'
cross_existence_key1 = 'vms_kss_os'
cross_existence_key2 = 'content_sattools_url'
NEED_FOR_SPEED_FLAG  = False   # True  if you wan to enable speed up 
...
result_gen_port_scri = '/Users/arahman/PRIOR_NCSU/SECU_REPOS/ghub-ansi/laincloud@lain/playbooks/roles/config/defaults/main.yaml'
RESULT_DEFAULT_PORT  = 'DEFAULT_PORT'
RAW_COUNT_KEYWORD    = 'RESULT_RAW_COUNT'
TP_COUNT_KEYWORD     = 'RESULT_TP_COUNT'
result_gen_script2   = '/Users/arahman/PRIOR_NCSU/SECU_REPOS/ghub-ansi/redhat-performance@satellite-performance/conf/satperf.yaml'
RESULT_PASSWORD      = 'HARDCODED_PASSWORD'
RESULT_USERNAME      = 'HARDCODED_USERNAME'
RESULT_PRIVATE_KEY   = 'HARDCODED_PRIVATE_KEY'
AFFECTED_KEYWORD     = 'AFFECTED_PLAY_COUNT'
result_gen_no_integ  = '/Users/arahman/PRIOR_NCSU/SECU_REPOS/ghub-ansi/redhat-performance@satellite-performance/playbooks/katello/roles/add_katello_repos/tasks/main.yaml'
NO_INTEG_KEYWORD     = 'NO_INTEGRITY_CHECK'

YAML_KEY             = 'YAML_FULL_PATH'
HTTP_HEADER          = 'INSECURE_HTTP'
TEST_DATFRAME_DIR    = '/Users/arahman/PRIOR_NCSU/SECU_REPOS/test-ansi/'
TEST_OUTPUT_CSV      = '/Users/arahman/Documents/OneDriveWingUp/OneDrive-TennesseeTechUniversity/Research/IaC/FixFalsePositive/Content-Taintible/output-taintible/OLD/V1_TEST_TP_OUTPUT.csv'
TEST_NO_INTEG_FILE   = '/Users/arahman/PRIOR_NCSU/SECU_REPOS/test-ansi/redhat-performance@satellite-performance/playbooks/katello/roles/add_katello_repos/tasks/main.yaml'
SATPERF_TEST_FILE    = '/Users/arahman/PRIOR_NCSU/SECU_REPOS/test-ansi/redhat-performance@satellite-performance/conf/satperf.yaml'